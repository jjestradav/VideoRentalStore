namespace Vidly.Migrations
{
    ...
    public partial class AddIDToUser : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("dbo.AspNetUserRoles", "UserId", c => c.String(nullable: false, maxLength: 255));
            AlterColumn("dbo.AspNetUsers", "Id", c => c.String(nullable: false, maxLength: 255));
            AlterColumn("dbo.AspNetUserClaims", "UserId", c => c.String(nullable: false, maxLength: 255));
            AlterColumn("dbo.AspNetUserLogins", "UserId", c => c.String(nullable: false, maxLength: 255));
